        ...
        <div className="fest-categories">
            ...
            <div className="category-container">
                <div className="category-card">
                    <img src="image6.jpg" alt="Cultural Fest" className="category-image" />
                ...
                <div className="category-card">
                    <img src="image5.jpg" alt="Tech Fest" className="category-image" />
                    <h2>Tech Fests</h2>
                    <p>Discover the latest innovations and technologies. Engage with cutting-edge startups and tech enthusiasts.</p>
                </div>
                <div className="category-card">
                    <img src="image4.jpg" alt="Sports Fest" className="category-image" />
                    <h2>Sports Fests</h2>
